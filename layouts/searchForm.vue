<template>
    <form id="searchform" class="form-inline" @submit.prevent>
        <div class="input-group">
			<span class="input-group-btn input-group-btnfirst"><a href="/random" class="btn btn-secondary btn-randomly"><span class="fa fa-random"></span></a></span>
...
export default {
    ...
    watch: {
        $route() {
            if (this.$store.state.localConfig["slliberty.reset_search_on_move"] !== false) this.reset();
        }
    }
}
</script>
