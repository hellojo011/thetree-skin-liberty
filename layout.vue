                ...
                <div id="bottom" class="liberty-footer">
                    ...
                    <ul class="footer-icons">
                        <li class="footer-poweredbyico">
                            <a href="//github.com/hellojo011/thetree-skin-liberty" target="_blank">Liberty Edited by DIGIWB</a> | <a href="//github.com/wjdgustn/thetree" target="_blank">the tree</a>
                        </li>
                    </ul>
                </div>
